...
// Fetch single blog from Hygraph by slug
            ...
            <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <section className="relative bg-gradient-to-r from-red-600 to-orange-500 text-white overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 pt-20 pb-12">
                        ...
                        >
                            <Link href="/blog" className="inline-flex items-center gap-2 text-orange-100 hover:text-white transition-colors mb-4">
                                <svg className="w-5 h-5" fill="rotate(180)" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex justify-center items-center gap-4 text-sm text-orange-100">
                                <div className="flex items-center gap-1">
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 2 00-2 2v12a2 2 0 002 2z" />
                                    </svg>
                ...
                <section className="container mx-auto px-6 py-16">
                    ...
                    >
                        ...
                        <article className="bg-white dark:bg-gray-800 rounded-3xl shadow-lg p-8 md:p-12 border border-gray-100 dark:border-gray-700 mx-auto">
                            <div className="prose dark:prose-invert prose-lg max-w-none" dangerouslySetInnerHTML={{ __html: blog.content.html }} />
                        </article>

                        {/* CTA Section */}
                        <div className="mt-12 text-center">
                            <Link href="/blog" className="inline-flex items-center gap-2 bg-gradient-to-r from-red-600 to-orange-500 text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg transition-shadow">
