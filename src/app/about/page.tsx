    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="container mx-auto px-6 py-24">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-orange-100 max-w-2xl mx-auto">
                We craft transformative experiences that elevate brands through creativity, strategy, and innovation.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">
                  Why Choose <span className="bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent">Golden Media?</span>
                </h3>
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                  We blend data-driven strategies with creative excellence to deliver transformative experiences that resonate and achieve results.
                </p>
                <Link
        ...
        <section className="container mx-auto px-6 py-16 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-300 mb-6">
            ...
            <Link
              href="https://www.youtube.com/@GoldenMediaNigeria"
              className="inline-flex items-center px-6 py-3 text-sm font-medium text-gray-900 dark:text-white bg-white dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 hover:border-gray-300 dark:hover:border-gray-500 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
