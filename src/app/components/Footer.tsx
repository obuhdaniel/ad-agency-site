  ...
  return (
    <footer className="bg-black text-white text-center py-10 px-6 md:px-16">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="text-center md:text-right">
          <p className="text-lg font-semibold">
            Optimizing the present, transforming the future
          </p>

          <Link
            href="mailto:daniel0292016@gmail.com"
            className="mt-4 flex items-center gap-2 bg-white text-black  px-6 py-2 rounded-full transition hover:bg-[#F5F5F5]"
          >
      ...
      <div className="text-center text-white text-sm mt-2">
        ...
        <a href="https://www.crimpbyte.com/">Crimpbyte Technologies</a>
      </div>
    </footer>
  );
}
