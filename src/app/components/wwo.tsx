...
export default function WhatWeOffer() {
  ...
  return (
    <section className="bg-white max-w-7xl mx-auto relative overflow-hidden">
      
      <div className="container mx-auto px-4 py-16 md:py-24 relative">
      <div className="max-w-4xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-12">
        <div className="inline-flex items-center bg-gray-100 rounded-full py-2 px-4 text-sm text-gray-600 mb-4">
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-gray-900">
          What We <span className="bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Offer</span>
        </h2>
        </div>
        ...
        {offerings.map((offer, index) => (
          ...
          >
          <div className="absolute -inset-2 bg-gradient-to-r from-gray-200 to-gray-100 rounded-2xl blur opacity-20 group-hover:opacity-40 transition-all duration-300" />
          <div className="relative">
            <div className="inline-flex items-center justify-center w-12 h-12 mb-4 bg-gray-100 rounded-xl text-gray-900">
            {offer.icon}
            </div>
