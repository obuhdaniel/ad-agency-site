...
const HeroSection = () => {
  return (
    <section
      className="font-aeonik max-w-7xl mx-auto bg-gray-50 relative overflow-hidden"
      style={{
        backgroundImage: "url(/gridbg1.jpg)",
      ...
      <div className="container mx-auto px-4 py-16 md:py-24 relative">
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          <div className="flex-1 space-y-8">
            ...
            >
              At Golden Media, we specialize in cutting-edge advertising
              solutions designed to help businesses reach their target audience,
