...
const HeroSection = () => {
  return (
    <section className="font-aeonik max-w-7xl mx-auto dark:bg-gray-950 relative overflow-hidden" style={{ backgroundImage: 'url(/gridbg1.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
        ...
        <motion.div
          ...
          className="inline-flex items-center bg-gray-100 dark:bg-gray-800 rounded-full py-2 px-4 text-sm text-gray-600 dark:text-gray-300"
        >
